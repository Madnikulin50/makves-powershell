...
$computers = "192.168.0.172", "192.168.0.77"
$disks = "c"
$file = "D:\t2\research\res.csv"
...
$computers | Foreach-Object {
    ...
    $computer = $_
    $ScriptBlock = {
        param($computer, $file, $disks, $sizelist, $filters, $fp) 
        
        $hashlen = 1048576
         Write-Host "computer $($computer)"
         Write-Host "file $($file)"
         Write-Host "disks $($disks)"
         Write-Host "sizelist $($sizelist)"
    ...
    Start-Job $ScriptBlock -ArgumentList $_, $file, $disks, $sizelist, $filters, $fp
}
